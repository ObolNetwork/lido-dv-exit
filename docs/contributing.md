...
Feel free to fork the lido-dv-exit repo and submit a pull request with your suggested changes.
...
- Publish your work in a branch under this [lido-dv-exit repo](https://github.com/ObolNetwork/lido-dv-exit).
- Keep track of all roadmap and feature work, as well as bug fixes and smaller changes via GitHub [issues](https://github.com/ObolNetwork/lido-dv-exit/issues).
...
lido-dv-exit is configured with [pre-commit](https://pre-commit.com) **githooks** that ensures pull
